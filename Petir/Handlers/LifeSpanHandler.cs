...
namespace Petir {
    internal class LifeSpanHandler : ILifeSpanHandler
    {
        ...
        //
        //     1. User clicks the window close button which sends an OS close notification (e.g.
        ...
        //
        //      8. Application's top-level window receives the OS close notification and allows the window to close
        //     based on the flag from #6.B(Return false). 
        //
        ...
        //     is destroyed.  
        //
        //      11. Application exits by calling CefQuitMessageLoop() if no
